...
class TestFMCVariableSets(common.TestCommon):
    ...
    def tearDown(self):
        ...
        if self.test_zone:
            self.csfw_client.delete_security_zone(self.domain_uuid, self.test_zone.id)
    ...
    def test_get_security_zone_list(self):
        ...
        zone_list = self.csfw_client.get_security_zones_list(self.domain_uuid)
    ...
    def test_get_security_zone_list(self):
        ...
        self.assertIsInstance(
            self.csfw_client.get_security_zone(self.domain_uuid, zone_list[0].id), FTDSecurityZoneModel
        )
    ...
    def test_delete_security_zone(self):
        ...
        deleted_zone = self.csfw_client.delete_security_zone(self.domain_uuid, self.test_zone.id)
